...
import {getAutoScroll, getIsElementInView} from "../../util/index.js";
...
export default function Navbar() {
    ...
    return (
        <motion.header
            ...
            style={{
                position: hero.bottom < 80 ? 'fixed' : 'absolute',
                top: hero.bottom < 80 ? 0 : 'calc(100vh - 80px)',
                backgroundColor: hero.bottom < 80 ? 'rgba(7,86,103,0.9)' : 'rgba(7,86,103,0.2)',
                boxShadow: hero.bottom < 80 ? '-1px 4.0px 16.0px hsl(0deg 0% 0% / 0.25)' : 'none',
                ...
                <Burger
                    ...
                    onClick={async () => {
                        ...
                        let activeLocation = locMap[window.location.pathname],
                            autoScroll = await getAutoScroll(),
                            isElementInView = await getIsElementInView(),
